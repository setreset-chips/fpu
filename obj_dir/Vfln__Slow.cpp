...
void Vfln::_ctor_var_reset() {
    ...
    fln__DOT__temp3i = VL_RAND_RESET_I(32);
    fln__DOT__temp3 = VL_RAND_RESET_I(32);
    fln__DOT__temp4i = VL_RAND_RESET_I(32);
    fln__DOT__temp4 = VL_RAND_RESET_I(32);
    fln__DOT__temp5i = VL_RAND_RESET_I(32);
    fln__DOT__temp5 = VL_RAND_RESET_I(32);
    fln__DOT__temp6 = VL_RAND_RESET_I(32);
    fln__DOT__temp7 = VL_RAND_RESET_I(32);
    fln__DOT__temp8i = VL_RAND_RESET_I(32);
    fln__DOT__op1i = VL_RAND_RESET_I(32);
    fln__DOT____Vcellinp__fa1____pinNumber2 = VL_RAND_RESET_I(32);
    fln__DOT____Vcellinp__fa2____pinNumber2 = VL_RAND_RESET_I(32);
    ...
    fln__DOT__fi0__DOT__f1__DOT__expF = VL_RAND_RESET_I(8);
    fln__DOT__fi0__DOT__f1__DOT__mantissa = VL_RAND_RESET_I(23);
    fln__DOT__fi0__DOT__f1__DOT__mantissaProd = VL_RAND_RESET_Q(48);
    fln__DOT__fi0__DOT__f1__DOT__i = 0;
    ...
    fln__DOT__fm6__DOT__expF = VL_RAND_RESET_I(8);
    fln__DOT__fm6__DOT__mantissa = VL_RAND_RESET_I(23);
    fln__DOT__fm6__DOT__mantissaProd = VL_RAND_RESET_Q(48);
    fln__DOT__fm6__DOT__i = 0;
    ...
    fln__DOT__fa3__DOT__largerMag = VL_RAND_RESET_I(1);
    fln__DOT__fa3__DOT__finalSign = VL_RAND_RESET_I(1);
    fln__DOT__fa3__DOT__num1Exp = VL_RAND_RESET_I(8);
    fln__DOT__fa3__DOT__num2Exp = VL_RAND_RESET_I(8);
    fln__DOT__fa3__DOT__finalExp = VL_RAND_RESET_I(8);
    fln__DOT__fa3__DOT__num1Mant = VL_RAND_RESET_I(24);
    fln__DOT__fa3__DOT__num2Mant = VL_RAND_RESET_I(24);
    fln__DOT__fa3__DOT__finalMant = VL_RAND_RESET_I(24);
    fln__DOT__fa3__DOT__sumMants = VL_RAND_RESET_I(25);
    fln__DOT__fa3__DOT__i = 0;
    fln__DOT__fa4__DOT__largerMag = VL_RAND_RESET_I(1);
    fln__DOT__fa4__DOT__finalSign = VL_RAND_RESET_I(1);
    fln__DOT__fa4__DOT__num1Exp = VL_RAND_RESET_I(8);
    fln__DOT__fa4__DOT__num2Exp = VL_RAND_RESET_I(8);
    fln__DOT__fa4__DOT__finalExp = VL_RAND_RESET_I(8);
    fln__DOT__fa4__DOT__num1Mant = VL_RAND_RESET_I(24);
    fln__DOT__fa4__DOT__num2Mant = VL_RAND_RESET_I(24);
    fln__DOT__fa4__DOT__finalMant = VL_RAND_RESET_I(24);
    fln__DOT__fa4__DOT__sumMants = VL_RAND_RESET_I(25);
    fln__DOT__fa4__DOT__i = 0;
}
