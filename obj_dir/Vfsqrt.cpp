...
void Vfsqrt::eval_step() {
    ...
    do {
        ...
        if (VL_UNLIKELY(++__VclockLoop > 100)) {
            ...
            VL_FATAL_MT("obj_dir/../fsqrt.sv", 1, "",
...
VL_INLINE_OPT void Vfsqrt::_combo__TOP__1(Vfsqrt__Syms* __restrict vlSymsp) {
    ...
    Vfsqrt* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
    vlTOPp->fsqrt__DOT__in1 = vlTOPp->var1;
    vlTOPp->fsqrt__DOT__in1 = (vlTOPp->fsqrt__DOT__in1 
                               >> 1U);
    vlTOPp->fsqrt__DOT__out = (vlTOPp->fsqrt__DOT__in1 
                               - (IData)(0x5f3759dfU));
    vlTOPp->res = vlTOPp->fsqrt__DOT__out;
}
