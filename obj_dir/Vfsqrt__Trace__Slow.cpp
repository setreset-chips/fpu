...
void Vfsqrt::traceInitSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->declBus(c+3,"fsqrt in1", false,-1, 31,0);
        tracep->declBus(c+4,"fsqrt out", false,-1, 31,0);
    }
}
...
void Vfsqrt::traceFullSub0(void* userp, VerilatedVcd* tracep) {
    ...
    // Body
    {
        ...
        tracep->fullIData(oldp+3,(vlTOPp->fsqrt__DOT__in1),32);
        tracep->fullIData(oldp+4,(vlTOPp->fsqrt__DOT__out),32);
    }
}
